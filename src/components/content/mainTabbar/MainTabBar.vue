...
<template>
  <div>
    <tab-bar>
      <tab-bar-item path="/home" activeColor="darkseagreen">
      ...
      <tab-bar-item path="/category" activeColor="darkseagreen">
      ...
      <tab-bar-item path="/shopcar" activeColor="darkseagreen">
        <img slot="item-icon" src="~assets/img/tabbar/shop_car.png" alt="">
        <img slot="item-icon-active" src="~assets/img/tabbar/shop_car_active.png" alt="">
        <div slot="item-text">购物车</div>
      </tab-bar-item>
      <tab-bar-item path="/profile" activeColor="darkseagreen">
